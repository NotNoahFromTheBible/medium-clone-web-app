...
A fully functional **Medium-inspired blogging application** built with **React (Vite)**, **Node.js**, **Express**, **TypeScript**, and **MongoDB**.   It includes complete authentication, post creation, and commenting functionalities — all within a clean and responsive UI.
